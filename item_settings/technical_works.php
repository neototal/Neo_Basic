...
<html>
    <head>
        ...
        $_SESSION['pth'] = "../";
        $_SESSION['title'] = "Technical Works";
        include_once '../Imports/header/basic_header.php';
        ?>
        <script type="text/javascript" src="tecnial_works/add_new.js"></script>
    <body class="w3-theme-light">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <h1 class="w3-header">Technical Works</h1>
                ...
                <div class="col-lg-2">
                    <button class="w3-theme-dark w3-button w3-input w3-hover-blue-grey" onclick="add_new_work()">Add New Work</button>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Technical Works</li>
                    </ul>
                </div>
            </div>
...
//                    alert(sending_value);
                    $.ajax({
                        url: "tecnial_works/get_count.php",
                        type: 'POST',
                        cache: false,
                        data: sending_value,
                        success: function (data) {
...
//                            alert(data);
                            ...
                            for (var i = 0; i < json.length; i++) {
                                load_data_of_table(json[i].iditem_list, json[i].name, json[i].dis, json[i].unit_of_mesher, div_body);
                            }
                            if (json.length == 0) {

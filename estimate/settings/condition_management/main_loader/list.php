...
$sql_query = "select * from estimate_catergory where ast='1' and active_state='".$showing_state."' and name like '%" . $search_value . "%' ORDER BY id DESC LIMIT " . $no_of_count . " OFFSET " . $stating_row_number."   ";
//echo $sql_query;

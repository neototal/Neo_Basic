...
$sql_query = "insert into tecnical_works(sdt,ast,user_login_iduser_login,name,dis,unit_of_mesher,vsp,dealer_rate,budget_rate,corperate_rate) values(now(),'1','".$userid."','".$name."','".$dis."','".$unit."','".$vsp."','".$dealer."','".$budget."','".$coperate."')";

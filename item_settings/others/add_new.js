          function add_new_work() {
                ...
                iHead.appendChild(document.createTextNode("Add Other work"));
                ...
                a_input.setAttribute("placeholder", "camera installing example other work");
                a_input.addEventListener("keydown", function () {
                    a_input.setAttribute("class", "w3-input w3-border w3-border-black");
                    $(iError).empty();
                });

                a_col_01.appendChild(document.createTextNode("Other Work Name"));

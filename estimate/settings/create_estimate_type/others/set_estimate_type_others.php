...
$sql_query = "insert into estimate_setup_others(ast,sdt,user_login_iduser_login,Estimate_type_idEstimate_type,others_idothers,estimate_in_state) values("
...
$database_connction = database();
$sql_query = "update estimate_type set other_work_state='1' where idEstimate_type='" . $id_of_estimate . "'";
$database_connction->query($sql_query);

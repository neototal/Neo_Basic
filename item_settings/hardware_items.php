...
<html>
    <head>
        ...
        $_SESSION['pth'] = "../";
        $_SESSION['title'] = "Hardware Item Management";
        ...
        <script type="text/javascript" src="hardware_item_list/type/hardware_type_add_new.js"></script>
        <script type="text/javascript" src="hardware_item_list/type/hardware_type_load_to_modal.js"></script>
        <script type="text/javascript" src="hardware_item_list/create_hardware_items.js"></script>
    </head>
    <body class="w3-theme-light">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <h1 class="w3-header">Hardware Item List</h1>
                ...
                <div class="col-lg-2">
                    <button class="w3-theme-dark w3-button w3-input w3-hover-blue-grey" onclick="add_new_item()">Add New</button>
                </div>
...
//                    alert(sending_value);
                    $.ajax({
                        url: "hardware_item_list/get_count.php",
                        type: 'POST',
                        cache: false,
                        data: sending_value,
                        success: function (data) {
...
//                    alert(sending_value);
                    $.ajax({
                        url: "hardware_item_list/list.php",
                        type: 'POST',
                        cache: false,
                        data: sending_value,
                        success: function (data) {
//                            alert(data);
                            ...
                            for (var i = 0; i < json.length; i++) {
                                load_data_of_table(json[i].idhardware_item_list, json[i].name, "", json[i].unit_of_measure, json[i].hardware_type_idhardware_type, json[i].item_type_name, div_body);
                            }
                            if (json.length == 0) {
                ...
                function load_data_of_table(id, name, dis, warranty, item_type_id, item_type_name, div_body) {
                    var a_row = document.createElement("div");
                    a_row.setAttribute("class", "row");
                    ...
                    aA_col_03_b.appendChild(document.createTextNode(warranty));
